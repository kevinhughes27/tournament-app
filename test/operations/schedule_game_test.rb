...
class ScheduleGameTest < ActiveSupport::TestCase
  ...
  test "checks for home team time conflicts" do
    ...
    schedule = ScheduleGame.new(new_game, @free_field.id, game.start_time, game.start_time + 90.minutes)
    schedule.perform
  ...
  test "checks for field conflicts" do
    ...
    schedule = ScheduleGame.new(new_game, game.field_id, game.start_time, game.start_time + 90.minutes)
    schedule.perform
  ...
  test "field conflict check works with timecap increments" do
    ...
    start_time = game.start_time + 90.minutes
  ...
  test "games checks for schedule order conflicts (dependent game)" do
    ...
    schedule = ScheduleGame.new(game1, @free_field.id, game2.start_time, game2.start_time + 90.minutes)
    schedule.perform
  ...
  test "games checks for schedule order conflicts (prerequisite game)" do
    ...
    schedule = ScheduleGame.new(game2, @free_field.id, game1.start_time, game1.start_time + 90.minutes)
    schedule.perform
